...
class CustomerInfo:
    def __init__(self, root):
        ...
        # display message
        self.label = Label(top, font=('arial', 50, 'bold'), text="LIST OF CUSTOMER", fg="light pink", anchor="center")
        self.label.grid(row=0, column=3, padx=10, pady=10)

        # display message
        self.name_label = Label(left, font=('arial', 20, 'bold'), text="NAME", fg="light pink", anchor="center")
        ...
        # display message
        self.room_no_label = Label(right, font=('arial', 20, 'bold'), text="ROOM N0", fg="light pink", anchor="center")
        ...
        # create home button
        self.home_button = Button(top, text="HOME", font=('', 15), bg="light pink", relief=RIDGE, height=2, width=15,
        ...
        self.display_button = Button(top, text="DISPLAY", font=('', 15), bg="light pink", relief=RIDGE, height=2, width=15,
