...
class CheckIN:
    ...
    def __init__(self, root):
        ...
        # display message
        self.label = Label(self.top, font=('arial', 50, 'bold'), text="CHECK IN", fg="light pink", anchor="center")
        self.label.grid(row=0, column=3, padx=10, pady=10)

        # name label
        self.name_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ENTER YOUR NAME :", fg="light pink",
                                anchor="w")
        ...
        # address label
        self.address_label = Label(self.bottom, font=('arial', 20, 'bold'), text="ENTER YOUR ADDRESS :", fg="light pink",
                                   anchor="w")
        ...
        self.submit_button = Button(self.checkbox, text="SUBMIT", font=('', 15), bg="light pink", relief=RIDGE, height=2,
                                    width=15,
                                    fg="black", anchor="center", command=submit_info)
        self.submit_button.grid(row=5, column=1, padx=10, pady=10)

        # back to home page
        self.back_home_button = Button(self.checkbox, text="HOME", font=('', 15), bg="light pink", relief=RIDGE, height=2,
                                       width=15,
                                       fg="black", anchor="center", command=main.home_ui)
        self.back_home_button.grid(row=5, column=2, padx=10, pady=10)

        Button(self.checkbox, text="reset", font=('', 15), bg="light pink", relief=RIDGE, height=2, width=15, fg="black",
